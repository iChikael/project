  ...
  return (
    <Box m="20px">
      ...
      >
        ...
        >
          <Button onClick={handleNavigationCustomers}>
            <StatBox
        ...
        <Box
          ...
          justifyContent="center"
        >
          <Button onClick={handleNavigationCars}>
            <StatBox
        ...
        <Box
          ...
          justifyContent="center"
        >
          <Button onClick={handleNavigationStaffs}>
            <StatBox
        ...
        <Box
          ...
          justifyContent="center"
        >
          <Button onClick={handleNavigationBillServices}>
            <StatBox
