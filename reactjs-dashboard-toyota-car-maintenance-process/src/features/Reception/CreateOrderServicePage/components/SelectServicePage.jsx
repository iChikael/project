...
const SelectServicePage = () => {
  ...
  const showToastSuccessMessage = () => {
    toast.success('Chọn dịch vụ bảo dưỡng, sửa chữa thành công!', {
  ...
  const showToastMaintennance = () => {
    toast.error('Vui lòng chọn một dịch vụ bảo dưỡng !', {
      position: toast.POSITION.TOP_RIGHT,
      autoClose: 1500,
      hideProgressBar: false,
      closeOnClick: true,
